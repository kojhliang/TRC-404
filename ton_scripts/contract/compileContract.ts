...
export async function getTrc404CollectionAndMasterAddress(compliedCodes: CompiledCodeList, admin_address: Address) {
    ...
    // off chain way to store collection content
    ...
    // ds~load_coins(), ;;FreeMint freemint_max_supply  , (freemint_max_supply + total_supply) <= max_supply()
    // ds~load_coins(), ;; freemint_price, like 5* 10^9 nano ton
    // ds~load_int(2) ;; mintable
